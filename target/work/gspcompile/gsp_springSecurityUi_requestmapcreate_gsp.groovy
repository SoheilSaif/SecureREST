...
class gsp_springSecurityUi_requestmapcreate_gsp extends GroovyPage {
public String getGroovyPageFileName() { "/WEB-INF/plugins/spring-security-ui-1.0-RC2/grails-app/views/requestmap/create.gsp" }
public Object run() {
Writer out = getOut()

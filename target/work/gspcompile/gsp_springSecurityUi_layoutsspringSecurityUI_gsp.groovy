...
public String getGroovyPageFileName() { "/WEB-INF/plugins/spring-security-ui-1.0-RC2/grails-app/views/layouts/springSecurityUI.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(19)
createTagBody(3, {->
invokeTag('message','g',98,['code':("spring.security.ui.create")],-1)
})
